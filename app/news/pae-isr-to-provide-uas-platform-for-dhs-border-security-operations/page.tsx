      ...
      <section className="pt-32 pb-12 bg-gradient-to-b from-[#414042] to-[#323232]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">PAE ISR to Provide UAS Platform for DHS Border Security Operations</h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="prose prose-lg max-w-none">
            <p className="text-lg text-[#414042] leading-relaxed mb-6">
              <strong>HATTIESBURG, Mississippi</strong> – PAE ISR has been selected to provide an unmanned aircraft system for a Department of Homeland Security program that seeks to enhance border security operations along the U.S. borders.
            </p>
          </motion.div>
        </div>
      </article>
