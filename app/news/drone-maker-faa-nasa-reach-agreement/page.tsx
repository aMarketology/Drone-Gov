      ...
      <section className="pt-32 pb-12 bg-gradient-to-b from-[#414042] to-[#323232]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Drone maker, FAA, NASA Reach Agreement</h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="prose prose-lg max-w-none">
            <p className="text-lg text-[#414042] leading-relaxed mb-6">
              Historic agreement reached between PAE ISR, the Federal Aviation Administration, and NASA to advance safe integration of unmanned aircraft systems into the national airspace.
            </p>
          </motion.div>
        </div>
      </article>
