        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="flex items-center gap-4 mb-6">
              <span className="px-4 py-1 bg-[#ee3124] text-white text-sm font-semibold rounded-full">Operations</span>
              <span className="text-gray-300">November 2023</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Resolute Eagle Demonstrates Advanced ISR Capabilities</h1>
          </motion.div>
        </div>
      </section>
      <section className="py-12 bg-white">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8 }} className="relative h-[400px] rounded-lg overflow-hidden shadow-2xl">
            <Image src="/IMG_1173 Kenneth Burger.JPG" alt="Article" fill className="object-cover" />
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="prose prose-lg max-w-none">
            <p className="text-lg text-[#414042] leading-relaxed mb-6">
              The Resolute Eagle UAS successfully demonstrated advanced intelligence, surveillance, and reconnaissance capabilities during recent field exercises, showcasing its runway independence and superior sensor integration.
            </p>
          </motion.div>
        </div>
      </article>
