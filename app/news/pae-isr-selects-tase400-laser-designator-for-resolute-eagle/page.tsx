        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-gray-300">May 2024</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">PAE ISR Selects TASE400 Laser Designator for Resolute Eagle</h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="prose prose-lg max-w-none">
            <p className="text-lg text-[#414042] leading-relaxed mb-6">
              PAE ISR has selected the TASE400 laser designator system for integration with the Resolute Eagle UAS, providing advanced targeting and designation capabilities for precision operations.
            </p>
          </motion.div>
        </div>
      </article>
