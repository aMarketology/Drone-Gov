    ...
    <div className="min-h-screen bg-[#f2f2f2]">
      ...
      <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-[#414042]">
        <div className="absolute inset-0">
          <Image
            src="/IMG_0053 (1) Kenneth Burger.PNG"
      ...
      <section className="relative py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          {/* Ground-Based ISR and Pattern of Life - Side by Side */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
            ...
            >
              ...
              <div className="p-8">
                <div className="w-12 h-1 bg-[#ee3124] mb-4"></div>
                <h2 className="text-3xl font-light text-[#414042] mb-4">Ground-Based ISR</h2>
            ...
            >
              <div className="relative h-[300px]">
                <Image
                  src="/Pattern of Life Recognition.jpg"
              ...
              <div className="p-8">
                <div className="w-12 h-1 bg-[#ee3124] mb-4"></div>
                <h2 className="text-3xl font-light text-[#414042] mb-4">Pattern of Life Recognition</h2>
                <p className="text-[#414042] leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-2xl font-light text-[#414042] mb-4">Force Protection</h3>
                <p className="text-[#414042] leading-relaxed">
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-2xl font-light text-[#414042] mb-4">Anti-Piracy</h3>
                <p className="text-[#414042] leading-relaxed">
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-2xl font-light text-[#414042] mb-4">Border Protection</h3>
                <p className="text-[#414042] leading-relaxed">
      ...
      <section className="relative py-20 bg-[#f2f2f2]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          {/* Two Column Layout for Humanitarian Services */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="p-8">
                <h3 className="text-3xl font-light text-[#414042] mb-4">Search and Rescue</h3>
            ...
            >
              ...
              <div className="p-8">
                <h3 className="text-3xl font-light text-[#414042] mb-4">Firefighting</h3>
                <p className="text-lg text-[#414042] leading-relaxed">
